...
export function Subscribe() {
  ...
  async function handleSubscribe(event: FormEvent) {
    ...
    await createSubscriber({
      variables: {
        name, // o nome vai dessa forma porque a variável tem o mesmo nome
        email, // ....
      }
    })
  ...
  return (
    <div className=" min-h-screen bg-blur bg-no-repeat flex flex-col items-center">
      ...
      <div className="w-full max-w-[1100px] flex items-center justify-between mt-20 mx-auto">
        ...
        <div className="p-8 bg-gray-700 border border-gray-500 rounded">
          ...
          <form onSubmit={handleSubscribe} className="flex flex-col gap-3 w-full">
            <input
              className="bg-gray-900 rounded px h-14 px-2"
              type="text"
      ...
      <img src="/src/assets/code-mockup.png" alt="" className="mt-5" />
    </div>
  )
}