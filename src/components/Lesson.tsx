      ...
      >
        <header className="flex items-center justify-between">
          {isLessonAvailable ? (
            ...
            <span className={`text-sm text-orange-500 font-medium flex items-center gap-2 first-letter:
            ${isActiveLesson ? 'text-white' : ''}`}>
...
// LessonProps is the interface with the items that will be received by the component Lesson